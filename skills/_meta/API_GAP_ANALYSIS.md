...
title: "Offpix Frontend vs Backend API - Análise de Lacunas (Role Admin)"
module: offpix
version: "1.1.0"
type: analysis
status: implemented
...
# Offpix Frontend vs Backend API - Análise de Lacunas
...
| PATCH | `/admin/companies/:companyId/configurations/providers/stripe/refresh-connection` | Atualizar Stripe OAuth |
...
### Contracts — gerenciamento de roles
...
| Registry | Contracts | 2 | Parcial (gerenciamento de roles) |
...
| PixwayID | Users | 8 | Parcial (ops avançadas) |
| PixwayID | Tenant Integration | 4 | 0% — módulo inteiro |
| PixwayID | Tenant Hosts | 4 | Parcial (ops de escrita) |
