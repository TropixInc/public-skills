---
id: PASS_SKILL_INDEX
title: "Índice de Skills do Pass"
module: pass
...
O módulo Pass possui duas implementações frontend:

| Projeto | Descrição | Rotas Operador | Rotas Usuário |
|---------|-----------|----------------|---------------|
...
Cada documento de fluxo possui seções separadas para SDK e teste-skills com componentes, hooks e rotas específicos.
